...
{
    unsafe class BK_Packet_Binding
    {
        ...
        static StackObject* get_Opcode_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BK.Packet instance_of_this_method = (BK.Packet)typeof(BK.Packet).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
