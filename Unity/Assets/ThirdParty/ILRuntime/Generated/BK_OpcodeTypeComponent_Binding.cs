...
{
    unsafe class BK_OpcodeTypeComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(BK.OpcodeTypeComponent);
        ...
        static StackObject* GetOpcode_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BK.OpcodeTypeComponent instance_of_this_method = (BK.OpcodeTypeComponent)typeof(BK.OpcodeTypeComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
