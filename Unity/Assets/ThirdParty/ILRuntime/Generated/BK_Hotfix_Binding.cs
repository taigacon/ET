...
{
    unsafe class BK_Hotfix_Binding
    {
        ...
        static StackObject* GetHotfixTypes_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BK.Hotfix instance_of_this_method = (BK.Hotfix)typeof(BK.Hotfix).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
