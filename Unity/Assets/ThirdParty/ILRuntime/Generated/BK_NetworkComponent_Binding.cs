...
{
    unsafe class BK_NetworkComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(BK.NetworkComponent);
            args = new Type[]{};
        ...
        static StackObject* get_MessagePacker_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BK.NetworkComponent instance_of_this_method = (BK.NetworkComponent)typeof(BK.NetworkComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
