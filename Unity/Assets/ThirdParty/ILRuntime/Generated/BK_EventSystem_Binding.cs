...
{
    unsafe class BK_EventSystem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(BK.EventSystem);
            args = new Type[]{typeof(System.String), typeof(BK.IEvent)};
        ...
        static StackObject* RegisterEvent_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BK.IEvent @e = (BK.IEvent)typeof(BK.IEvent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            BK.EventSystem instance_of_this_method = (BK.EventSystem)typeof(BK.EventSystem).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
